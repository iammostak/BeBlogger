...
const blogs = [
   {
      ...
      content: [
         ...
         [
            "img",
            "https://miro.medium.com/max/1100/1*y7TwupwaoWMPeYNHYOlQHQ.jpeg",
         ],
         ...
         ["point", "Grokking the System Design Interviews:"],
         [
            "point_content",
         ...
         [
            "img",
            "https://miro.medium.com/max/1100/1*8lKDJjoqRNfDTtffPo0-ng.jpeg",
         ],
         [
            "description",
